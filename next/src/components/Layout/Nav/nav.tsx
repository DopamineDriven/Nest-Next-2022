...
const github: GitHubProps[] = [
  {
    name: "GitHub",
    href: "/github",
    description: "Overview of Cortina's GitHub Integration",
    current: false
  },
  {
    name: "Repositories",
    href: "/github/repositories",
    description: "Detailed view of all of Cortina's Repositories",
    current: false
  },
  {
    name: "Crew",
    href: "/github/crew",
    description: "View members of Cortina's GitHub crew",
    current: false
  },
  {
    name: "Activity",
    href: "/github/activity",
    description: "View recent activity in Cortina Repositories",
    current: false
  }
];
...
export interface NavProps extends AuthData {}

const GlobalNav = ({ viewer, loading, loggedIn, error }: NavProps) => {
