...
/**
     Discord: ({ clipPath, ...props }: SVGAttribs<"className" | "clipPath" | "aria-hidden">) => JSX.Element;
    Facebook: ({ ...props }: SVGAttribs<"className" | "aria-hidden">) => JSX.Element;
    GitHub: ({ ...props }: SVGAttribs<"className" | "aria-hidden" | "width" | "height">) => JSX.Element;
    Google: ({ ...props }: SVGAttribs<"className" | "aria-hidden" | "width" | "height">) => JSX.Element;
    Hubspot: ({ ...props }: SVGAttribs<"className" | "aria-hidden">) => JSX.Element;
    Instagram: ({ ...props }: SVGAttribs<"className" | "aria-hidden">) => JSX.Element;
LinkedIn: ({ ...props }: SVGAttribs<"className" | "aria-hidden">) => JSX.Element;
StackOverflow: ({ ...props }: SVGAttribs<"className" | "aria-hidden">) => JSX.Element;
Twitter: ({ ...props }: SVGAttribs<"className" | "aria-hidden">) => JSX.Element;
TypeScript: ({ ...props }: SVGAttribs<"className" | "aria-hidden">) => JSX.Element;
    YouTube: ({ ...props }: SVGAttribs<"className" | "aria-hidden">) => JSX.Element;
 * const CompanyIcons = {
  Discord: ({
    clipPath,
    ...props
  ...
  Facebook: ({ ...props }: SVGAttribs<"className" | "aria-hidden">) => {
    return (
      <svg
        xmlns='http://www.w3.org/2000/svg'
        width='24'
  ...
  Hubspot: ({ ...props }: SVGAttribs<"className" | "aria-hidden">) => {
    return (
      <svg
        {...props}
        xmlns='http://www.w3.org/2000/svg'
  ...
  Instagram: ({ ...props }: SVGAttribs<"className" | "aria-hidden">) => {
    return (
      <svg
        xmlns='http://www.w3.org/2000/svg'
        width='24'
  ...
  LinkedIn: ({ ...props }: SVGAttribs<"className" | "aria-hidden">) => {
    return (
      <svg
        xmlns='http://www.w3.org/2000/svg'
        width='24'
  ...
  Twitter: ({ ...props }: SVGAttribs<"className" | "aria-hidden">) => {
    return (
      <svg
        xmlns='http://www.w3.org/2000/svg'
        width='24'
  ...
  TypeScript: ({ ...props }: SVGAttribs<"className" | "aria-hidden">) => {
    return (
      <svg
        width='87'
        height='63'
  ...
  YouTube: ({ ...props }: SVGAttribs<"className" | "aria-hidden">) => {
    return (
      <svg
        width='24'
        height='24'
