...
export type HubSpotTableProps = {
  hubspotData: GetContactsOneGraphResponseProps;
};

export default function HubSpotTable({ hubspotData }: HubSpotTableProps) {
  const hubspotRes =
    hubspotData.data.hubspot.makeRestCall.get.jsonBody.results;
  return (
