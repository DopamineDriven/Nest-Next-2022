/* 58f58e584f2f31ced6c61b353f0a8a948d0543f6
...
export type AuthDetailedExtended = {
  __typename?: 'AuthDetailedExtended';
  accessToken?: Maybe<Scalars['String']>;
  jwt?: Maybe<JwtDecoded>;
  operation: EntryOperations;
  refreshToken?: Maybe<Scalars['String']>;
  session?: Maybe<Session>;
  user: User;
};
...
export type EntryConnectionExtended = {
  __typename?: 'EntryConnectionExtended';
...
export enum EntryOperations {
  AuthDetailedExtended = 'AUTH_DETAILED_EXTENDED',
  EntryConnectionExtended = 'ENTRY_CONNECTION_EXTENDED'
}

export type EntryOperationsUnion = AuthDetailedExtended | EntryConnectionExtended;

export type EntryOperationsUnionOutput = EntryOpsUnionInterface & {
  __typename?: 'EntryOperationsUnionOutput';
  connect: EntryOperationsUnion;
};

export type EntryOpsUnionInterface = {
  connect: EntryOperationsUnion;
};
...
export type Query = {
  ...
  viewerEntriesPaginated: EntryOperationsUnionOutput;
};
...
export type ViewerEntriesInput = {
  cursor?: InputMaybe<EntryWhereUniqueInput>;
  distinct?: InputMaybe<Array<EntryScalarFieldEnum>>;
  orderBy?: InputMaybe<Array<EntryOrderByWithRelationAndSearchRelevanceInput>>;
  pagination: PaginationArgsInput;
...
export type ResolversTypes = ResolversObject<{
  ...
  AuthDetailedExtended: ResolverTypeWrapper<AuthDetailedExtended>;
  ...
  EntryConnectionExtended: ResolverTypeWrapper<EntryConnectionExtended>;
  ...
  EntryOperationsUnion: ResolversTypes['AuthDetailedExtended'] | ResolversTypes['EntryConnectionExtended'];
  EntryOperationsUnionOutput: ResolverTypeWrapper<Omit<EntryOperationsUnionOutput, 'connect'> & { connect: ResolversTypes['EntryOperationsUnion'] }>;
  EntryOpsUnionInterface: ResolversTypes['EntryOperationsUnionOutput'];
...
export type ResolversParentTypes = ResolversObject<{
  ...
  AuthDetailedExtended: AuthDetailedExtended;
  ...
  EntryConnectionExtended: EntryConnectionExtended;
  ...
  EntryEdge: EntryEdge;
  EntryListRelationFilter: EntryListRelationFilter;
  EntryOperationsUnion: ResolversParentTypes['AuthDetailedExtended'] | ResolversParentTypes['EntryConnectionExtended'];
  EntryOperationsUnionOutput: Omit<EntryOperationsUnionOutput, 'connect'> & { connect: ResolversParentTypes['EntryOperationsUnion'] };
  EntryOpsUnionInterface: ResolversParentTypes['EntryOperationsUnionOutput'];
  EntryOrderByRelationAggregateInput: EntryOrderByRelationAggregateInput;
  EntryOrderByRelevanceInput: EntryOrderByRelevanceInput;
  EntryOrderByWithRelationAndSearchRelevanceInput: EntryOrderByWithRelationAndSearchRelevanceInput;
  EntryRelationFilter: EntryRelationFilter;
...
export type AuthDetailedExtendedResolvers<ContextType = any, ParentType extends ResolversParentTypes['AuthDetailedExtended'] = ResolversParentTypes['AuthDetailedExtended']> = ResolversObject<{
  accessToken?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  jwt?: Resolver<Maybe<ResolversTypes['JwtDecoded']>, ParentType, ContextType>;
  operation?: Resolver<ResolversTypes['EntryOperations'], ParentType, ContextType>;
  refreshToken?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  session?: Resolver<Maybe<ResolversTypes['Session']>, ParentType, ContextType>;
  user?: Resolver<ResolversTypes['User'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type EntryConnectionExtendedResolvers<ContextType = any, ParentType extends ResolversParentTypes['EntryConnectionExtended'] = ResolversParentTypes['EntryConnectionExtended']> = ResolversObject<{
  connection?: Resolver<ResolversTypes['EntryConnection'], ParentType, ContextType>;
  operation?: Resolver<ResolversTypes['EntryOperations'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type EntryOperationsUnionResolvers<ContextType = any, ParentType extends ResolversParentTypes['EntryOperationsUnion'] = ResolversParentTypes['EntryOperationsUnion']> = ResolversObject<{
  __resolveType: TypeResolveFn<'AuthDetailedExtended' | 'EntryConnectionExtended', ParentType, ContextType>;
}>;

export type EntryOperationsUnionOutputResolvers<ContextType = any, ParentType extends ResolversParentTypes['EntryOperationsUnionOutput'] = ResolversParentTypes['EntryOperationsUnionOutput']> = ResolversObject<{
  connect?: Resolver<ResolversTypes['EntryOperationsUnion'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type EntryOpsUnionInterfaceResolvers<ContextType = any, ParentType extends ResolversParentTypes['EntryOpsUnionInterface'] = ResolversParentTypes['EntryOpsUnionInterface']> = ResolversObject<{
  __resolveType: TypeResolveFn<'EntryOperationsUnionOutput', ParentType, ContextType>;
  connect?: Resolver<ResolversTypes['EntryOperationsUnion'], ParentType, ContextType>;
}>;
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  viewerEntriesPaginated?: Resolver<ResolversTypes['EntryOperationsUnionOutput'], ParentType, ContextType, RequireFields<QueryViewerEntriesPaginatedArgs, 'viewerEntriesInput'>>;
}>;
...
export type Resolvers<ContextType = any> = ResolversObject<{
  ...
  AuthDetailedExtended?: AuthDetailedExtendedResolvers<ContextType>;
  ...
  EntryConnectionExtended?: EntryConnectionExtendedResolvers<ContextType>;
  EntryCount?: EntryCountResolvers<ContextType>;
  EntryEdge?: EntryEdgeResolvers<ContextType>;
  EntryOperationsUnion?: EntryOperationsUnionResolvers<ContextType>;
  EntryOperationsUnionOutput?: EntryOperationsUnionOutputResolvers<ContextType>;
  EntryOpsUnionInterface?: EntryOpsUnionInterfaceResolvers<ContextType>;
