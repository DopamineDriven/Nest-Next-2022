...
export abstract class IMutation {
    ...
    abstract createEntryWithAxios(createNew: EntryCreateOneInput): Entry | Promise<Entry>;

    abstract createNewComment(commentCreateInput: CreatNewCommentInput): Comment | Promise<Comment>;

    abstract createNewEntry(entryCreateInput: EntryCreateOneInput): Entry | Promise<Entry>;

    abstract createNewProfile(createNewProfileInput: CreateOneProfile): Profile | Promise<Profile>;

    abstract nuevoEntry(nuevoEntry: EntryCreateOneInput): Entry | Promise<Entry>;

    abstract registerNewUser(userCreateInput: SignupInput): AuthDetailed | Promise<AuthDetailed>;
...
export abstract class IQuery {
    ...
    abstract nodeField(cursor: string): NodeBaseFieldUnion[] | Promise<NodeBaseFieldUnion[]>;
    ...
    abstract viewerCommentsPaginated(viewerCommentsPaginatedInput: FindManyCommentsPaginatedInput): CommentConnection | Promise<CommentConnection>;
    ...
    abstract viewerFieldsPaginated(viewerFieldsPaginatedInput: ViewerFieldsPaginatedInput): ViewerFieldsPaginatedConnection | Promise<ViewerFieldsPaginatedConnection>;

    abstract viewerMediaItemsPaginated(viewerMediaItemsPaginatedInput: FindManyMediaItemsPaginatedInput): MediaItemConnection | Promise<MediaItemConnection>;

    abstract viewerProfile(): Profile | Promise<Profile>;

    abstract viewerSessionsPaginated(viewerSessionssPaginatedInput: FindManySessionsPaginatedInput): SessionConnection | Promise<SessionConnection>;
}
...
export type NodeBaseFieldUnion = Account | Category | Comment | Connection | Entry | MediaItem | Profile | Session | User;
