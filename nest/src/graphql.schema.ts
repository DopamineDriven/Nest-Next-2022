...
export abstract class IMutation {
    ...
    abstract createNewComment(commentCreateInput: CreateewCommentInput): Comment | Promise<Comment>;
    ...
    abstract createNuevoEntryMutation(createNuevoEntryInput: EntryCreateNuevoInput): Entry | Promise<Entry>;
