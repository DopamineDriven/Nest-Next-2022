...
-- AlterTable
ALTER TABLE "Category" ALTER COLUMN "creatorId" DROP NOT NULL;
...
-- AlterTable
ALTER TABLE "Connection" ALTER COLUMN "ownerId" DROP NOT NULL;

-- AlterTable
ALTER TABLE "Entry" ALTER COLUMN "authorId" DROP NOT NULL;

-- AlterTable
ALTER TABLE "MediaItem" ALTER COLUMN "userId" DROP NOT NULL;
