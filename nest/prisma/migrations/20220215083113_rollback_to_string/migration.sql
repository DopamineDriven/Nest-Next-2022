...
-- AlterTable
ALTER TABLE "Profile" ALTER COLUMN "coverPhoto" DROP NOT NULL,
ALTER COLUMN "coverPhoto" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "User" ALTER COLUMN "image" DROP NOT NULL,
ALTER COLUMN "image" SET DEFAULT E'https://dev-to-uploads.s3.amazonaws.com/uploads/articles/g4apn65eo8acy988pfhb.gif',
