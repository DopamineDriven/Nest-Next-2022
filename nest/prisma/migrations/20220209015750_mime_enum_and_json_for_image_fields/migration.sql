/*
  ...
  - A unique constraint covering the columns `[id,userId]` on the table `MediaItem` will be added. If there are existing duplicate values, this will fail.
...
-- DropIndex
DROP INDEX "MediaItem_userId_key";
...
-- CreateIndex
CREATE UNIQUE INDEX "MediaItem_id_userId_key" ON "MediaItem"("id", "userId");
