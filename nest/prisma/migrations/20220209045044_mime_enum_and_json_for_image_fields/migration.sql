...
*/
-- CreateEnum
CREATE TYPE "MediaItemDestination" AS ENUM ('COVER_IMAGE', 'AVATAR', 'COMMENT_ATTACHMENT', 'ENTRY_ATTACHMENT', 'FEATURED_IMAGE');
...
-- AlterTable
ALTER TABLE "MediaItem" ADD COLUMN     "destination" "MediaItemDestination";
