...
-- DropIndex
DROP INDEX "MediaItem_name_userId_key";
...
-- AlterTable
ALTER TABLE "Comment" ALTER COLUMN "body" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "Entry" ADD COLUMN     "mediaItemId" TEXT,
ALTER COLUMN "content" DROP NOT NULL,
ALTER COLUMN "content" SET DATA TYPE TEXT,
ALTER COLUMN "featuredImage" SET NOT NULL,
ALTER COLUMN "featuredImage" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "Profile" ALTER COLUMN "bio" DROP NOT NULL,
ALTER COLUMN "bio" SET DATA TYPE TEXT,
ALTER COLUMN "activiyFeed" DROP NOT NULL,
ALTER COLUMN "activiyFeed" SET DATA TYPE TEXT,
ALTER COLUMN "recentActivity" DROP NOT NULL,
ALTER COLUMN "recentActivity" SET DATA TYPE TEXT;
